...
function renderStagedCourses() {
    ...
    staged.innerHTML = keys.map(k => {
        ...
        return `<span class="inline-flex items-center gap-1 px-2 py-1 bg-[#fde6e6] text-[#a51c30] text-sm rounded-lg">
            ${escapeHtml(c.id)}
            <button type="button" onclick="unstageCourse('${k}')" class="hover:text-[#801b30]">
